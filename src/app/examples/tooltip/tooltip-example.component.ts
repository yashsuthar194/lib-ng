    ...
    <div class="example-page">
      ...
      <section class="example-section">
        ...
        <div class="button-row">
          <button class="btn" libTooltip="Save your changes">💾 Save</button>
          <button class="btn" libTooltip="Edit this item">✏️ Edit</button>
          <button class="btn" libTooltip="Delete permanently">🗑️ Delete</button>
        </div>
      </section>
      ...
      <section class="example-section">
        ...
        <div class="position-demo">
          <div class="position-row">
            <button class="btn btn--sm" libTooltip="Top Start" libTooltipPosition="top-start">
              ↖ Top Start
            </button>
            <button class="btn btn--sm" libTooltip="Top" libTooltipPosition="top">↑ Top</button>
            <button class="btn btn--sm" libTooltip="Top End" libTooltipPosition="top-end">
              ↗ Top End
            </button>
          </div>
          <div class="position-row position-row--sides">
            <button class="btn btn--sm" libTooltip="Left" libTooltipPosition="left">← Left</button>
            <button class="btn btn--sm" libTooltip="Right" libTooltipPosition="right">
              Right →
            </button>
          </div>
          <div class="position-row">
            <button class="btn btn--sm" libTooltip="Bottom Start" libTooltipPosition="bottom-start">
              ↙ Bottom Start
            </button>
            <button class="btn btn--sm" libTooltip="Bottom" libTooltipPosition="bottom">
              ↓ Bottom
            </button>
            <button class="btn btn--sm" libTooltip="Bottom End" libTooltipPosition="bottom-end">
              ↘ Bottom End
            </button>
          </div>
        </div>
      ...
      <section class="example-section">
        ...
        <div class="button-row">
          <button class="btn" libTooltip="Default tooltip">Default</button>
          <button class="btn btn--info" libTooltip="Helpful information" libTooltipVariant="info">
            ℹ️ Info
          </button>
          <button
            class="btn btn--warning"
            libTooltip="Proceed with caution"
            libTooltipVariant="warning"
          >
            ⚠️ Warning
          </button>
          <button
            class="btn btn--error"
            libTooltip="This action is dangerous"
            libTooltipVariant="error"
          >
            ❌ Error
          </button>
        </div>
      ...
      <section class="example-section">
        ...
        <div class="button-row">
          <button class="btn" libTooltip="Instant (0ms)" [libTooltipShowDelay]="0">Instant</button>
      ...
      <section class="example-section">
        ...
        <div class="button-row">
          <button class="btn" libTooltip="Press Tab to focus me">Focus me with Tab</button>
          <button class="btn" libTooltip="Press Escape to hide">Then press Escape</button>
        </div>
      </section>
    </div>
  `,
