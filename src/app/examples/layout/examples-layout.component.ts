...
@Component({
  ...
  standalone: true,
  imports: [RouterOutlet, RouterLink, RouterLinkActive, HeaderComponent, SafeHtmlPipe],
  template: `
          ...
          <nav class="sidebar-nav">
            @for (section of navSections; track section.title; let i = $index) {
              <div class="nav-section" [class.nav-section--expanded]="expandedSections().has(i)">
                ...
                >
                  <span class="section-icon" [innerHTML]="section.icon | safeHtml"></span>
  ...
  navSections: NavSection[] = [
    {
      ...
      links: [
        { path: 'table/basic', label: 'Basic Table', description: 'Simple array data binding' },
        {
          ...
          description: 'Async data with loading state',
        },
        {
          path: 'table/columns',
          label: 'Column Definitions',
          description: 'Declarative column templates',
        },
        ...
        { path: 'table/pagination', label: 'Pagination', description: 'Page navigation' },
        {
          ...
          description: 'FormArray with inline editing',
        },
      ],
    },
    {
      ...
      links: [
        {
          path: 'select/basic',
          label: 'Basic Select',
          description: 'Single select with static options',
        },
        {
          path: 'select/searchable',
          label: 'Searchable',
          description: 'Type-ahead search filtering',
        },
        {
          path: 'select/multi',
          label: 'Multi-Select',
          description: 'Multiple selections with chips',
        },
        {
          path: 'select/template',
          label: 'Custom Templates',
          description: 'Avatars, groups, conditional',
        },
        {
          path: 'select/forms',
          label: 'Forms Integration',
          description: 'Reactive Forms validation',
        },
      ],
    },
    {
      ...
      links: [
        {
          path: 'input/basic',
          label: 'Basic Input',
          description: 'Sizes, variants, types, states',
        },
      ...
      links: [
        {
          ...
          description: 'Notifications, positions, stacking',
        },
      ],
    },
    {
      ...
      links: [
        {
          ...
          description: 'Positions, variants, accessibility',
        },
      ],
    },
    {
      ...
      links: [
        {
          ...
          description: 'Variants, appearances, dismissible',
        },
      ],
    },
    {
      ...
      links: [
        {
          ...
          description: 'Bar, circular, spinner indicators',
        },
      ],
    },
    // ============================================
    ...
    // ============================================
    {
      ...
      links: [{ path: 'card', label: 'Card Examples', description: 'Variants, images, clickable' }],
    },
    {
      title: 'Badge',
      ...
      links: [
        {
          ...
          description: 'Variants, pulse, status, overlays',
        },
      ],
    },
    {
      ...
      links: [
        {
          path: 'avatar',
          label: 'Avatar Examples',
          description: 'Images, initials, presence, groups',
        },
      ],
    },
    {
      ...
      links: [
        {
          ...
          description: 'GPU-accelerated loading placeholders',
        },
      ],
    },
    {
    ...
    // ============================================
    {
      ...
      links: [
        {
          path: 'breadcrumb',
          label: 'Breadcrumb Examples',
          description: 'Navigation trail with icons',
        },
      ],
    },
    {
    ...
    // ============================================
    {
      ...
      links: [
        {
          path: 'datepicker',
          label: 'DatePicker Examples',
          description: 'Date, range, time, datetime pickers',
        },
      ],
    },
  ];
