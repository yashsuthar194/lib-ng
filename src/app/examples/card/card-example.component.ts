      ...
      <section class="example-section">
        ...
        <div class="card-grid">
          <lib-card>
            ...
            <lib-card-content>
              This is the card content. You can put any content here including text, images, and
              other components.
            </lib-card-content>
            <lib-card-footer>
      ...
      <section class="example-section">
        ...
        <div class="card-grid card-grid--3">
          <lib-card variant="elevated">
            ...
            <lib-card-content> Card with shadow elevation. </lib-card-content>
          </lib-card>
          ...
          <lib-card variant="outlined">
            ...
            <lib-card-content> Card with border only. </lib-card-content>
          </lib-card>
          ...
          <lib-card variant="filled">
            ...
            <lib-card-content> Card with solid background. </lib-card-content>
          </lib-card>
        </div>
      </section>
      ...
      <section class="example-section">
        ...
        <div class="card-grid card-grid--3">
          ...
          <lib-card [clickable]="true" variant="outlined" (cardClick)="onCardClick('Project 2')">
            ...
            <lib-card-content> Outlined clickable card with hover effects. </lib-card-content>
          </lib-card>
          ...
          <lib-card [clickable]="true" variant="filled" (cardClick)="onCardClick('Project 3')">
            ...
            <lib-card-content> Filled clickable card variant. </lib-card-content>
          </lib-card>
        </div>
      </section>
