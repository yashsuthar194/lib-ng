...
import { ModalService, ModalAnimation, MODAL_REF } from '../../../../library/modal';
  ...
  template: `
    <div class="nested-dialog">
      ...
      <div class="dialog-content">
        <p>{{ data.message }}</p>
        <p class="depth-info">Modal depth: <strong>{{ data.depth }}</strong></p>
        
        <div class="actions">
          <button class="btn btn--primary" (click)="openAnother()">
            🪟 Open Another Modal
          </button>
          <button class="btn btn--secondary" (click)="openAlert()">
            ℹ️ Open Alert
          </button>
        </div>
      </div>
