  ...
  template: `
    <div class="example-page">
      ...
      <section class="example-section">
        ...
        <div class="animation-grid">
          @for (anim of animationTypes; track anim.type) {
            <button 
              class="anim-btn"
              (click)="openWithAnimation(anim.type)"
            >
      ...
      <section class="example-section origin-section">
        ...
        <p class="hint">The modal animates FROM the clicked button's position TO the center. Try buttons in different corners!</p>
      ...
      <section class="example-section">
        ...
        <p class="hint">Open a modal that can open another modal. Tests stacked modals and z-index management.</p>
        
        <button class="nested-btn" (click)="openNestedModal()">
          🪟 Open Nestable Modal
        </button>
        ...
        <div class="event-log">
          ...
          @empty {
            <div class="event-item event-item--empty">
              Open and close modals to see events...
            </div>
          }
        </div>
      </section>
...
export class AnimatedModalExampleComponent {
  ...
  readonly animationTypes = [
    ...
    { type: 'slide-up' as ModalAnimation, icon: '⬆️', label: 'Slide Up', description: 'From bottom' },
    { type: 'slide-down' as ModalAnimation, icon: '⬇️', label: 'Slide Down', description: 'From top' },
