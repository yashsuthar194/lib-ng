  ...
  template: `
    <div class="example-page">
      ...
      <section class="example-section">
        ...
        <div class="button-row">
          <button class="btn" (click)="showWithAction()">
      ...
      <section class="example-section">
        ...
        <div class="button-row">
          <button class="btn" (click)="showMultiple(3)">
            Show 3 Toasts
          </button>
          <button class="btn" (click)="showMultiple(6)">
            Show 6 Toasts (triggers removal)
          </button>
          <button class="btn btn--outline" (click)="dismissAll()">
            Dismiss All
          </button>
        </div>
      </section>
      ...
      <section class="example-section">
        ...
        <div class="button-row">
          <button class="btn" (click)="showWithDuration(2000)">
            2 seconds
          </button>
          <button class="btn" (click)="showWithDuration(5000)">
            5 seconds
          </button>
          <button class="btn" (click)="showWithDuration(0)">
      ...
      <section class="example-section">
        ...
        <div class="button-row">
          <button class="btn" (click)="showNoIcon()">
            No Icon
          </button>
          <button class="btn" (click)="showNoDismiss()">
            No Dismiss Button
          </button>
          <button class="btn" (click)="showMinimal()">
            Minimal (no icon, no dismiss)
          </button>
        </div>
      </section>
    </div>
