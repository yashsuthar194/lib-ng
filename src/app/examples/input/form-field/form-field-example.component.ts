    ...
    <div class="example-page">
      ...
      <section class="example-section">
        ...
        <form [formGroup]="loginForm" (ngSubmit)="onLogin()" class="form">
          <lib-form-field label="Email" [required]="true" [error]="emailError()">
            <svg libPrefix viewBox="0 0 24 24" fill="currentColor">
              <path
                d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm0 4l-8 5-8-5V6l8 5 8-5v2z"
              />
            </svg>
            <input libInput type="email" formControlName="email" autocomplete="email" />
          </lib-form-field>

          <lib-form-field label="Password" [required]="true" [error]="passwordError()">
            <svg libPrefix viewBox="0 0 24 24" fill="currentColor">
              <path
      ...
      <section class="example-section">
        <h2>Field States</h2>
        <div class="form">
          <lib-form-field label="Normal Field" hint="This is a helpful hint text">
            <input libInput type="text" placeholder="Enter text..." />
          </lib-form-field>

          <lib-form-field label="Required Field" [required]="true" hint="This field is required">
            <input libInput type="text" placeholder="Required..." />
          </lib-form-field>

          <lib-form-field label="Disabled Field">
            <input libInput type="text" disabled value="Cannot edit this" />
          </lib-form-field>

          <lib-form-field label="Readonly Field">
      ...
      <section class="example-section">
        ...
        <div class="form">
          ...
          <lib-form-field label="Unlimited Growth" hint="No max rows - grows indefinitely">
            <textarea
              libInput
