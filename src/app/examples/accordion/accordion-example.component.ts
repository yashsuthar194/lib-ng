    ...
    <div class="example-page">
      ...
      <section class="example-section">
        ...
        <lib-accordion>
          <lib-accordion-item header="What is Angular?">
            ...
            It provides a comprehensive set of tools for developing, testing, and
            deploying applications.
          </lib-accordion-item>
          <lib-accordion-item header="What are Signals?">
            Signals are a reactive primitive that provides fine-grained reactivity.
            They automatically track dependencies and notify consumers of changes.
          </lib-accordion-item>
          <lib-accordion-item header="What is OnPush?">
            OnPush is a change detection strategy that only checks a component
            when its inputs change or an event is triggered within it.
          </lib-accordion-item>
        </lib-accordion>
      </section>
      ...
      <section class="example-section">
        ...
        <lib-accordion [multiple]="true">
          ...
          <lib-accordion-item header="Panel 2">
            Open me while Panel 1 is open!
          </lib-accordion-item>
      ...
      <section class="example-section">
        ...
        <lib-accordion #controlledAccordion [multiple]="true" (accordionChange)="onAccordionChange($event)">
      ...
      <section class="example-section">
        ...
        <p class="hint">Form state is preserved when collapsed. Try filling the form, collapsing, and re-opening.</p>
