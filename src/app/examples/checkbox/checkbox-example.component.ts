    ...
    <div class="example-page">
      ...
      <section class="example-section">
        ...
        <div class="checkbox-column">
          ...
          <lib-switch [(ngModel)]="notifications"> Enable Notifications </lib-switch>
          <lib-switch size="sm" [(ngModel)]="compact"> Compact (small) </lib-switch>
          <lib-switch size="lg" [(ngModel)]="premium"> Premium Features (large) </lib-switch>
        </div>
      </section>
      ...
      <section class="example-section">
        ...
        <p class="hint">
          Custom icons for checked/unchecked states with smooth crossfade animation.
        </p>
        <div class="checkbox-column">
      ...
      <section class="example-section">
        ...
        <div class="checkbox-row">
          <lib-checkbox [ripple]="true" [(ngModel)]="rippleCheckbox"
            >Checkbox with ripple</lib-checkbox
          >
